...
//============================================================================================
    ...
    parameter Integer Dynamic "To operate tray in unsteady mode" annotation(
...
//=============================================================================================
    ...
    Real rho_c[Nc](each unit = "mol/m^3") "Component Molar Density";
    Real rho(unit = "mol/m^3") "Mixture Molar Density";
...
//==============================================================================
//Mole Balance
    Fin .* xin_c[:] + Fvap_s[1] .* xvap_sc[1, :] + Fliq_s[1] .* xliq_sc[1, :] - Fout .* xout_c[:] - Fvap_s[2] .* xvap_sc[2, :] - Fliq_s[2] .* xliq_sc[2, :] = if Dynamic == 1 then der(M) else zeros(Nc);
