...
package CSTR
  ...
  model test1
    ...
    parameter data.Ethyleneoxide eo;
    parameter data.Water w;
    parameter data.Ethyleneglycol eg;
    parameter data.Diethyleneglycol deg;
    parameter data.GeneralProperties C[Nc] = {eo, w, eg, deg};
    parameter Integer Nc = 4;
    Simulator.UnitOperations.CSTR bmr1(Af_r = {0.2, 0.01}, BC_r = {1, 1}, C = C, Coef_cr = {{-1, -1}, {-1, 0}, {1, -1}, {0, 1}}, DO_cr = {{1,1}, {0,0}, {0,0}, {0,0}}, Dynamics = true, Ef_r = {0,0}, Mode = "Isothermal", Nc = Nc, Nr = 2, Phase = "Liquid", Pset = 101325, V = 2) annotation(
