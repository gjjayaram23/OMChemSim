...
package Absorption
  ...
  model AbsColumn
    ...
    Tray tray[Nt](each Nc = Nc, each C = C, each Dynamic = dynamic);
  annotation(
  ...
  model Test
    ...
    Simulator.Examples.Absorption.ms air_acetone( C = C, DelF = 0.1, Disturbance_Variable = Simulator.Types.variable.Flow, Inlet_Disturbance = Simulator.Types.disturbance.Step,Nc = Nc, UserInput = true, timestep = 2) annotation(
      Placement(visible = true, transformation(origin = {-88, -84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Simulator.Examples.Absorption.AbsColumn abs( C = C,Nc = Nc, Nt = 3, dynamic = 1) annotation(
      Placement(visible = true, transformation(origin = {-20, -6}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
    Simulator.Examples.Absorption.ms top(Nc = Nc, C = C, T(start = 320), xvap(start = 1)) annotation(
      Placement(visible = true, transformation(origin = {62, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Simulator.Examples.Absorption.ms bottom(Nc = Nc, C = C, T(start = 311)) annotation(
